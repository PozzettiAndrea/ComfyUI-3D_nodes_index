...
[Installation](#installation) - [Node Reference](#node-reference) - [Features](#features) - [Documentation](https://fxtd.org/radiance_docs/) - [**What's New!**](#release-notes)
...
### Production Updates
- **EXR Export**: Direct scene-linear EXR download from the Viewer.
- **Documentation**: Completely overhauled Node Reference covering all 67 nodes.
...
- **GPU Accelerated** - 10-50x faster with CUDA & Metal
...
### Option 2: Manual Installation (By OS)

Navigate to `ComfyUI/custom_nodes` and clone the repo:
```bash
...
|----------|-------|-------------|
| **HDR & Color** | 30 | Professional HDR processing & Color Science |
| **Film & Camera** | 15 | Film grain, camera simulation, and effects |
| **Upscale** | 7 | Professional AI and algorithmic upscaling |
| **Viewer** | 3 | Scopes, analysis, and interactive viewing |
| **IO & Utilities** | 12 | Video IO, EXR, and production tools |
