...
As in v1, download and place the [photomaker-v2.bin](https://huggingface.co/TencentARC/PhotoMaker-V2/blob/main/photomaker-v2.bin) file in the `comfyui/models/photomaker` directory.
